...
def hybrid_a_star_planning(start, goal, ox, oy, xy_resolution, yaw_resolution):
    ...
    while True:
        ...
        if c_id in openList:
            ...
            print("current(x,y,yaw)=(%f,%f,%f)" % (current.x_index * XY_GRID_RESOLUTION, 
                                            current.y_index * XY_GRID_RESOLUTION,
                                            current.yaw_index * YAW_GRID_RESOLUTION))
        else:
            continue
        ...
        for neighbor in get_neighbors(current, config, ox, oy,
            ...
            if neighbor_index not in openList \
                ...
                #print("neighbor(x,y,yaw)=(%f,%f,%f)" % (neighbor.x_index * XY_GRID_RESOLUTION, 
                #                            neighbor.y_index * XY_GRID_RESOLUTION,
                #                            neighbor.yaw_index * YAW_GRID_RESOLUTION))
